...
# from llm.utils.sftp import SFTP
...
class E2MapArgs():
    def __init__(self) -> None:
        ...
        self.llm_pkg_path = osp.join(source_path, 'llm')
        self.rgb_local_dir_path = osp.join(self.llm_pkg_path, 'event_images')
        # self.rgb_remote_dir_path = osp.join(remote_path, 'images')
        self.update_local_dir_path = osp.join(self.llm_pkg_path, 'update_output')
        ...
        self.score_coef = rospy.get_param(rospy.get_name() + "/score_coef")
...
class E2Map():
    def __init__(self, args) -> None:
        ...
        # obstacle map
        map_save_dir = osp.join(self._data_path, "vlmaps")
        ...
        # self._llm_pkg_path = args.llm_pkg_path
        ...
        self._score_coef = args.score_coef
        self._tau = args.tau
