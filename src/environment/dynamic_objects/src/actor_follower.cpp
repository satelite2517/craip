...
void ActorFollower::PublishPath() {
    ...
    // pose2.pose.position.y = -1.175916;
    ...
    pose6.pose.position.x = -4.689591;
    pose6.pose.position.y = -1.948580;
    pose6.pose.position.z = 1.0;
    path_msg.poses.push_back(pose6);

    geometry_msgs::PoseStamped pose7;
    pose7.header.stamp = ros::Time::now();
    pose7.header.frame_id = "map";
    pose7.pose.position.x = -7.087419;
    pose7.pose.position.y = -1.948580;
    pose7.pose.position.z = 1.0;
    path_msg.poses.push_back(pose7);
