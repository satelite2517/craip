...
public:
  GlobalLocalizationTestNode() : nh() {
    ...
    globalmap_pub = nh.advertise<sensor_msgs::PointCloud2>("/localization/globalmap", 1, true);
    points_pub = nh.advertise<sensor_msgs::PointCloud2>("/localization/aligned_points", 1);
